...
{
	// auth
	protected static $account = 'aSvwzuFnc5c1jBVI2ZtEIpOliK0TxbLg'; //укажите логин
	protected static $key     = '8fTRAmgpvG8or33t5P6YmzYsSYops2RL'; //укажите ключ
	...
	{
		$where .= '.php' . (($get) ? "?" . $get : '');
		$where = 'http://integration.cdek.ru/' . $where;
